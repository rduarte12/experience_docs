...
\begin{enumerate}[label=\textbf{\arabic*}.] 
    ...
    \item \textbf{DUARTE, R. M.}; PONCIANO, J. R.; VALEM, L. P. \textbf{Gaussian Rank-Based Neighborhood Degree for Graph Neural Networks in Image Classification.} In: \textbf{Anais do XLI Simpósio Brasileiro de Bancos de Dados (SBBD 2026)}, São Carlos, SP, Brasil, 2026. \textbf{\textit{(Publicado)}}. \\
    $\bullet$ \textbf{Status:} Publicado em Anais de Congresso (Qualis A4). \\
...
\subsection{Artigos Aceitos}
\begin{enumerate}[label=\textbf{\arabic*}.]

    \item \textbf{DUARTE, R. M.}; BRITO, G. M.; VALEM, L. P. \textbf{Rank Correlation Meets Gaussian Degree Normalization in GNNs for Image Classification.} In: \textbf{Proceedings of the 39th SIBGRAPI Conference on Graphics, Patterns and Images (SIBGRAPI 2026)}, Goiânia, GO, Brasil, 2026. \textbf{(Aceito para publicação)}. \\
    $\bullet$ \textbf{Status:} Aceito para publicação em Anais de Congresso, Trilha Principal (Qualis A3). \\
    $\bullet$ \textbf{Relevância:} Propõe o D-GRaNDe, que unifica a construção do grafo de correlação por Densidade (DGCG) com a normalização de grau GRaNDe, mostrando que grafos de correlação de ranking e a normalização dinâmica de grau são complementares e que sua combinação supera cada técnica isoladamente.

    \item BENATO, B. C.; VALEM, L. P.; BRITO, G. M.; BEZERRA, I. H. C.; \textbf{DUARTE, R. M.}; NONATO, L. G. \textbf{An Introduction to Graph Neural Networks in Computer Vision: A Practical Perspective.} In: \textbf{Proceedings of the 39th SIBGRAPI Conference on Graphics, Patterns and Images (SIBGRAPI 2026), Trilha de Tutoriais}, Goiânia, GO, Brasil, 2026. \textbf{(Aceito para publicação)}. \\
    $\bullet$ \textbf{Status:} Aceito para publicação, Trilha de Tutoriais (Qualis A3). \\
    $\bullet$ \textbf{Relevância:} Tutorial prático que aborda os fundamentos de GNNs e sua aplicação à classificação, recuperação e segmentação de imagens, incluindo a ferramenta de visualização GCNVis para inspeção de grafos visuais.
