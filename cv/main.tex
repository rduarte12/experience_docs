...
\begin{onecolentry}
    ...
    \item \textbf{DUARTE, R. M.}; PONCIANO, J. R.; VALEM, L. P. \textit{"Gaussian Rank-Based Neighborhood Degree for Graph Neural Networks in Image Classification."} In: \textbf{Proceedings of the 41st Brazilian Symposium on Databases (SBBD 2026)}, São Carlos, SP, Brazil, 2026, pp. 575--588.
    \begin{itemize}[topsep=0.05cm, parsep=0.05cm, leftmargin=0.5cm, label={--}]
        \item \textbf{Status:} Published in Conference Proceedings (Qualis A4).
    ...
    \item \textbf{DUARTE, R. M.}; BRITO, G. M.; VALEM, L. P. \textit{"Rank Correlation Meets Gaussian Degree Normalization in GNNs for Image Classification."} In: \textbf{Proceedings of the 39th SIBGRAPI Conference on Graphics, Patterns and Images (SIBGRAPI 2026)}, Goiânia, GO, Brazil, 2026.
    \begin{itemize}[topsep=0.05cm, parsep=0.05cm, leftmargin=0.5cm, label={--}]
        \item \textbf{Status:} Accepted for publication, Main Track (Qualis A3).
        \item \textbf{Relevance:} Proposes D-GRaNDe, unifying the Density-Guided Correlation Graph (DGCG) construction with GRaNDe degree normalization, showing that rank-correlation graphs and dynamic degree normalization are complementary and jointly outperform either component alone.
    \end{itemize}

    \vspace{0.15cm}

    \item BENATO, B. C.; VALEM, L. P.; BRITO, G. M.; BEZERRA, I. H. C.; \textbf{DUARTE, R. M.}; NONATO, L. G. \textit{"An Introduction to Graph Neural Networks in Computer Vision: A Practical Perspective."} In: \textbf{Proceedings of the 39th SIBGRAPI Conference on Graphics, Patterns and Images (SIBGRAPI 2026), Tutorial Track}, Goiânia, GO, Brazil, 2026.
    \begin{itemize}[topsep=0.05cm, parsep=0.05cm, leftmargin=0.5cm, label={--}]
        \item \textbf{Status:} Accepted for publication, Tutorial Track (Qualis A3).
        \item \textbf{Relevance:} Practical tutorial covering GNN foundations and their application to image classification, retrieval, and segmentation, including the GCNVis visualization tool for inspecting visual graphs.
    \end{itemize}
